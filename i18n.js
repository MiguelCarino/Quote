...
const I18N = {
    es: {
        ...
        "Tax details added from Fiscal": "Datos fiscales añadidos desde Fiscal",
        "Remove tax details": "Quitar datos fiscales",
        "Remove tax details from this quotation?": "¿Quitar los datos fiscales de esta cotización?",
        "This card comes from a newer Fiscal than this page understands": "Esta tarjeta viene de un Fiscal más nuevo de lo que esta página entiende",
        "Only your own tax card can go on a quotation": "Solo tu propia tarjeta fiscal puede ir en una cotización",
        'PDF export failed': 'Falló la exportación a PDF',
    ...
    'pt-BR': {
        ...
        "Tax details added from Fiscal": "Dados fiscais adicionados pelo Fiscal",
        "Remove tax details": "Remover dados fiscais",
        "Remove tax details from this quotation?": "Remover os dados fiscais deste orçamento?",
        "This card comes from a newer Fiscal than this page understands": "Este cartão vem de um Fiscal mais novo do que esta página entende",
        "Only your own tax card can go on a quotation": "Somente o seu próprio cartão fiscal pode ir num orçamento",
        'PDF export failed': 'Falha ao exportar o PDF',
    ...
    ja: {
        ...
        'Notes': '備考',
        'Add Item': '追加',
        "Tax details added from Fiscal": "Fiscalから税務情報を追加しました",
        "Remove tax details": "税務情報を削除",
        "Remove tax details from this quotation?": "この見積から税務情報を削除しますか？",
        "This card comes from a newer Fiscal than this page understands": "このカードは、このページが対応していない新しいFiscalのものです",
        "Only your own tax card can go on a quotation": "見積に載せられるのはご自身の税務カードだけです",
        'PDF export failed': 'PDFの書き出しに失敗しました',
        'Update Item': '更新',
        'Clear': 'クリア',
    ...
    ru: {
        ...
        "Tax details added from Fiscal": "Налоговые данные добавлены из Fiscal",
        "Remove tax details": "Убрать налоговые данные",
        "Remove tax details from this quotation?": "Убрать налоговые данные из этой сметы?",
        "This card comes from a newer Fiscal than this page understands": "Эта карточка из более новой версии Fiscal, чем понимает эта страница",
        "Only your own tax card can go on a quotation": "В смету можно поставить только вашу собственную налоговую карточку",
        'PDF export failed': 'Не удалось выгрузить PDF',
